...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioButtonDuration1 = findViewById(R.id.radioButtonDuration1);
        radioButtonDuration2 = findViewById(R.id.radioButtonDuration2);
        radioButtonDuration3 = findViewById(R.id.radioButtonDuration3);
    }
